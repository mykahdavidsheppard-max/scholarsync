...
// ---- EXPOSE ALL FUNCTIONS GLOBALLY (required for ES modules) ----
Object.assign(window, {
  switchAuth, signIn, signUp, signOut, showForgot,
  nav, toggleSidebar, closeSidebar, toggleTheme,
  saveSchedule, tempSavePeriod,
  saveID, loadWeather,
  addHW, toggleHW, deleteHW,
  saveNote, loadNote, loadNoteItem,
  addDeadline, deleteDeadline,
  addExam, deleteExam,
  setTimerMode, toggleTimer, resetTimer,
  filterDeck, addFlashcard,
  logAbsence, deleteAbsence,
  renderCalendar, changeMonth, openCalDay, addCalEvent, deleteCalEvent,
  postAnnouncement, deleteAnnouncement,
  openClassroom, joinClass, createClass, postAssignment, switchCDTab, calcWhatIf,
  openPassRequest, selectDest, endPass, sendPassReply, sendPassReplyDesktop,
  approvePass, denyPass, endPassTeacher, sendTeacherMsg, verifyPass, verifyPassTeacher, renderPassPanels, renderTPPanels,
  createClub, addSportResult, deleteSport,
  createPoll, castVote, deletePoll,
  filterDir,
  addLF, deleteLF,
  addCarpool, deleteCP,
  addChatMember, createChat, openChat, sendChatMsg,
  addStudyGroup, joinStudyGroup, deleteSG,
  addReminder, deleteReminder,
  selectAvatar, saveProfile,
  approveTeacher, grantAdmin, removeTeacher, removeAdmin, bulkApproveTeachers,
