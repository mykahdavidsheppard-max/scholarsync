...
window.switchAuth=switchAuth;window.signIn=signIn;window.signUp=signUp;
window.signOut=signOut;window.showForgot=showForgot;window.nav=nav;
window.toggleSidebar=toggleSidebar;window.closeSidebar=closeSidebar;
window.toggleTheme=toggleTheme;window.saveSchedule=saveSchedule;
window.tempSavePeriod=tempSavePeriod;window.saveID=saveID;
window.loadWeather=loadWeather;window.addHW=addHW;window.toggleHW=toggleHW;
window.deleteHW=deleteHW;window.saveNote=saveNote;window.loadNote=loadNote;
window.loadNoteItem=loadNoteItem;window.addDeadline=addDeadline;
window.deleteDeadline=deleteDeadline;window.addExam=addExam;
window.deleteExam=deleteExam;window.setTimerMode=setTimerMode;
window.toggleTimer=toggleTimer;window.resetTimer=resetTimer;
window.filterDeck=filterDeck;window.addFlashcard=addFlashcard;
window.deleteFlashcard=deleteFlashcard;window.deleteDeck=deleteDeck;
window.logAbsence=logAbsence;window.deleteAbsence=deleteAbsence;
window.renderCalendar=renderCalendar;window.changeMonth=changeMonth;
window.openCalDay=openCalDay;window.addCalEvent=addCalEvent;
window.deleteCalEvent=deleteCalEvent;window.postAnnouncement=postAnnouncement;
window.deleteAnnouncement=deleteAnnouncement;window.openClassroom=openClassroom;
window.joinClass=joinClass;window.createClass=createClass;
window.postAssignment=postAssignment;window.switchCDTab=switchCDTab;
window.calcWhatIf=calcWhatIf;window.openPassRequest=openPassRequest;
window.selectDest=selectDest;window.endPass=endPass;
window.sendPassReply=sendPassReply;window.sendPassReplyDesktop=sendPassReplyDesktop;
window.approvePass=approvePass;window.denyPass=denyPass;
window.endPassTeacher=endPassTeacher;window.sendTeacherMsg=sendTeacherMsg;
window.openResumeModal=openResumeModal;window.verifyPass=verifyPass;
window.verifyPassTeacher=verifyPassTeacher;window.renderTPPanels=renderTPPanels;
window.createClub=createClub;window.openClubPortal=openClubPortal;
window.backToClubs=backToClubs;window.switchClubTab=switchClubTab;
window.sendClubMsg=sendClubMsg;window.addClubSignup=addClubSignup;
window.toggleClubSignup=toggleClubSignup;window.postClubAnnouncement=postClubAnnouncement;
window.joinClubByCode=joinClubByCode;window.addSportResult=addSportResult;
window.deleteSport=deleteSport;window.createPoll=createPoll;
window.castVote=castVote;window.deletePoll=deletePoll;
window.filterDir=filterDir;window.addLF=addLF;window.deleteLF=deleteLF;
window.addCarpool=addCarpool;window.deleteCP=deleteCP;
window.addChatMember=addChatMember;window.createChat=createChat;
window.openChat=openChat;window.sendChatMsg=sendChatMsg;
window.sendGroupChatMsg=sendGroupChatMsg;window.deleteChat=deleteChat;
window.applyChatRestriction=applyChatRestriction;
window.liftChatRestriction=liftChatRestriction;
window.addStudyGroup=addStudyGroup;window.joinStudyGroup=joinStudyGroup;
window.deleteSG=deleteSG;window.addReminder=addReminder;
window.deleteReminder=deleteReminder;window.selectAvatar=selectAvatar;
window.saveProfile=saveProfile;window.approveTeacher=approveTeacher;
window.grantAdmin=grantAdmin;window.removeTeacher=removeTeacher;
window.removeAdmin=removeAdmin;window.bulkApproveTeachers=bulkApproveTeachers;
window.openModal=openModal;window.closeAllModals=closeAllModals;
window.sendStaffMsg=sendStaffMsg;window.previewFile=previewFile;
window.clearFilePreview=clearFilePreview;window.toggleVoiceRecorder=toggleVoiceRecorder;
